...
if (!$cache_loaded) {
	...
	// Misc config
		...
		$cf['KU_RANDOMSEED']        = 'CHANGEME'; // Type a bunch of random letters/numbers here, any large amount (35+ characters) will do
	...
	// Language / timezone / encoding
		...
		putenv('TZ=UTC'); // The time zone which the server resides in
